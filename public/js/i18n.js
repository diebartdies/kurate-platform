...
const translations = {
    'es': {
        ...
        'Exit': 'Salir',
        'KuraTe': 'KuraTe',
        'Find verified professionals of Professionals.': 'Encontrá profesionales verificados de Profesionales.',
        '¿Qué necesitás?, ': 'Profesionales, Conexión Virtual, Contenido Multimedia, Chat en línea',
        'Virtual': 'Virtual',
        'Entrance': 'Entrada',
        ' access this platform.': ' ingresar a esta plataforma.',
        ...
        'KuraTe does not create, produce, or modify any of the content found in the ads, yet all ads posted must adhere to our standards regarding age and content.': 'KuraTe no crea, produce ni modifica ninguno de los contenidos que aparecen en los anuncios; no obstante, todos los anuncios publicados deben cumplir con nuestros estándares en materia de edad y contenido.',
        'KuraTe enforces a strict policy against human trafficking, prostitution, and any illegal activities. We work in collaboration with law enforcement, following legal procedures such as subpoenas, to investigate any criminal actions. Breaching our strict policy may lead to reporting to law enforcement. I pledge not to use this site in a manner that contravenes KuraTe\u2019s policies, or any national, state, or local laws, and I commit to reporting any infringements to the authorities.': 'KuraTe aplica una política estricta contra la trata de personas, la prostitución y cualquier actividad ilegal. Colaboramos con las fuerzas de seguridad y seguimos los procedimientos legales correspondientes, como las órdenes judiciales, para investigar cualquier acción delictiva. El incumplimiento de nuestra política estricta puede dar lugar a una denuncia ante las fuerzas de seguridad. Me comprometo a no utilizar este sitio de manera que contravenga las políticas de KuraTe ni ninguna ley nacional, provincial o local, y me comprometo a denunciar cualquier infracción ante las autoridades.',
        ...
        'Professional Access:': 'Acceso de profesional:',
        'Professional Access:': 'Acceso de profesional:',
        'Professional Login': 'Inicio de profesional',
        'Professional Login': 'Inicio de profesional',
        'Professional Registration': 'Registro profesional',
        'Professional Registration': 'Registro profesional',
        'Why KuraTe': 'Por qué KuraTe',
        'Platform details and house rules': 'Detalles de la plataforma y reglas de juego',
        '← Back to home': '← Volver al inicio',
        'Two ways to belong — publish as a model or browse as a guest. Same sanctuary, different advantages.': 'Dos formas de pertenecer — publicá como profesional o navegá como invitado. Mismo plataforma, distintas ventajas.',
        'For Models': 'Para profesionals',
        'For Professionals': 'Para profesionals',
        'Guest registration': 'Registro de invitado',
        'Create an account': 'Crear una cuenta',
        'Choose how you want to join KuraTe.': 'Elegí cómo querés unirte a KuraTe.',
        ...
        'Create your model profile — first time only. If you already have an account, use Login.': 'Creá tu perfil profesional — solo la primera vez. Si ya tenés cuenta, usá Iniciar sesión.',
        'Create your professional profile — first time only. If you already have an account, use Login.': 'Creá tu perfil profesional — solo la primera vez. Si ya tenés cuenta, usá Iniciar sesión.',
        ...
        'Professional Registration option': 'Registro profesional',
        'Professional registration option': 'Registro profesional',
        ...
        'Public name for your guest account — not a model profile.': 'Nombre público de tu cuenta invitado — no es un perfil profesional.',
        'Public name for your guest account — not a professional profile.': 'Nombre público de tu cuenta invitado — no es un perfil profesional.',
        ...
        'Professional Registration': 'Registro profesional',
        'Professional registration': 'Registro profesional',
        'Join KuraTe as a Professional. Complete every required field and upload your verification photos. Admin review typically takes up to 48 hours.': 'Únase a KuraTe como Profesional. Complete todos los campos obligatorios y cargue sus fotos de verificación. La revisión del administrador suele demorar hasta 48 horas.',
        ...
        'After admin approval, sign in and choose your category, specialties, bio, and photos from your model dashboard.': 'Tras la aprobación del administrador, inicie sesión y elija su categoría, especialidades, biografía y fotos desde su panel de profesional.',
        'After admin approval, sign in and choose your category, specialties, bio, and photos from your professional dashboard.': 'Tras la aprobación del administrador, inicie sesión y elija su categoría, especialidades, biografía y fotos desde su panel de profesional.',
        ...
        'You must be at least 18 years old to register as a model.': ' registrarse como profesional.',
        'You must be at least 18 years old to register as a professional.': ' registrarse como profesional.',
        'Sign in with your model account email.': 'Inicie sesión con el correo de su cuenta de profesional.',
        'Sign in with your professional account email.': 'Inicie sesión con el correo de su cuenta de profesional.',
        'Enter Sanctuary': 'Entrar',
        ...
        'Did you mistype your email? Check it and try again, or register as a model.': '¿Escribió mal su correo? Revíselo e intente de nuevo, o regístrese como profesional.',
        ...
        'Register as a model': 'Registrarse como profesional',
        ...
        'Google sign-in complete. Add your WhatsApp number and birth date to finish your Professional Registration.': 'Inicio de sesión con Google completado. Agregue su número de WhatsApp y fecha de nacimiento para terminar el Registro profesional.',
        ...
        'Already browsing as a guest? You can register here as a model with the same email.': '¿Ya navega como invitada? Puede registrarse aquí como profesional con el mismo correo.',
        ...
        'This email is already registered as a model. Please sign in.': 'Este correo ya está registrado como profesional. Inicie sesión.',
        ...
        'Join as a Professional — we help you get visible, not alone.': 'Unite como Professional — le ayudamos a ser visible, no está sola.',
        ...
        'Model dashboard and WhatsApp contact shield': 'Panel de profesional y escudo de contacto WhatsApp',
        'Professional dashboard and WhatsApp contact shield': 'Panel de profesional y escudo de contacto WhatsApp',
        'Category visibility from Standard to verificados': 'Visibilidad por categoría de Standard a verificados',
        'For Guests — Your Security': 'Para invitados — Su seguridad',
        'Browse discreetly. We protect your privacy by design.': 'Navegue con profesionalidad. Protegemos su privacidad por diseño.',
        ...
        'Model contact details shielded — no raw numbers in the grid': 'Contactos de profesionals protegidos — sin números expuestos en la grilla',
        'Professional contact details shielded — no raw numbers in the grid': 'Contactos de profesionals protegidos — sin números expuestos en la grilla',
        ...
        'Welcome to KuraTe!': '¡Bienvenida a KuraTe!',
        ...
        'No models match your current selection.': 'Ningún profesional coincide con su selección actual.',
        'No professionals match your current selection.': 'Ningún profesional coincide con su selección actual.',
        'No models have been revealed yet. Please check back later.': 'Aún no se han revelado profesionals. Vuelve más tarde.',
        'No professionals have been revealed yet. Please check back later.': 'Aún no se han revelado profesionals. Vuelve más tarde.',
        ...
        'Professionals Directory': 'Directorio de profesionals',
        'Models Directory': 'Directorio de profesionals',
        'Filter': 'Filtrar',
        'No professionals match your filters.': 'Ningún profesional coincide con tus filtros.',
        'No models match your filters.': 'Ningún profesional coincide con tus filtros.',
        'Admin Menu': 'Menú de Admin',
        'Professional Profiles': 'Perfiles de profesionals',
        'Model Profiles': 'Perfiles de profesionals',
        ...
        'Our Professionals will be revealed on {date}.': 'Nuestros Profesionales se revelarán el {date}.',
        ...
        'If you no longer wish to remain on KuraTe, you can permanently delete your profile and all associated data.': 'Si ya no desea permanecer en KuraTe, puede eliminar permanentemente su perfil y todos los datos asociados.',
        ...
        'Horario fin': 'Horario fin',
        'Vacaciones desde': 'Vacaciones desde',
        'Vacaciones hasta': 'Vacaciones hasta',
        'Fotos': 'Fotos',
        'Subir': 'Subir',
        'Category and Pricing Table': 'Tabla de Categorías y Precios',
        'Level': 'Nivel',
        'Monthly Price': 'Precio Mensual',
        'Currency': 'Moneda',
        'Edit Mode': 'Modo Edición',
        'Usa WhatsApp': 'Usa WhatsApp',
        'Usa Telegram': 'Usa Telegram',
        'Please enter your password to confirm account deletion': 'Ingrese su contraseña para confirmar la eliminación de la cuenta',
        ...
        'Your profile in the guide:': 'Tu perfil en la guía:',
        'Clients search for professionals by area and services. Your profile appears as a card with the following elements:': 'Los clientes buscan profesionales por zona y servicios. Tu perfil aparece como una tarjeta con los siguientes elementos:',
        'Main photo:': 'Foto principal:',
        "It's the first thing the client sees. Choose a clear, professional photo.": 'Es lo primero que el cliente ve. Elegí una foto clara y profesional.',
        'Alias:': 'Alias:',
        'Your public name on the platform.': 'Tu nombre público en la plataforma.',
        'Distance:': 'Distancia:',
        'Shown automatically based on client location. Closer = more visible.': 'Se muestra automáticamente según la ubicación del cliente. A más cercano, más visible.',
        'Reviews and rating:': 'Reseñas y puntuación:',
        'Previous client reviews directly influence your positioning.': 'Las opiniones de clientes anteriores influyen directamente en tu posicionamiento.',
        'Reviews': 'Reseñas',
        ...
        'Rating': 'Puntuación',
        'Comment': 'Comentario',
        'Share your experience...': 'Compartí tu experiencia...',
        'Submit Review': 'Enviar Reseña',
        'Please select a rating.': 'Por favor seleccioná una puntuación.',
        'Please write a comment.': 'Por favor escribí un comentario.',
        'Submitting...': 'Enviando...',
        'Review submitted! Thank you.': '¡Reseña enviada! Gracias.',
        ...
        'Category:': 'Categoría:',
        'Indicates your level (Experto, Maestro, Profesional, Técnico, Inicial). Choose the one that best represents your experience.': 'Indica tu nivel (Experto, Maestro, Profesional, Técnico, Inicial). Elegí la que mejor represente tu experiencia.',
        'Services:': 'Servicios:',
        'The specialties you offer. Choose them well to appear in the right searches.': 'Las especialidades que ofrecés. Elegilas bien para aparecer en las búsquedas correctas.',
        'Bio:': 'Bio:',
        'Briefly describe what you do and why choose you.': 'Describí brevemente qué hacés y por qué elegirte.',
        'How search works:': 'Cómo funciona la búsqueda:',
        'The client chooses their area and type of service.': 'El cliente elige su zona y tipo de servicio.',
        'Results are ordered by: 1) Proximity, 2) Reviews and rating, 3) Category.': 'Los resultados se ordenan por: 1) Cercanía, 2) Reseñas y puntuación, 3) Categoría.',
        'More positive reviews and higher category = higher in results.': 'Más reseñas positivas y mejor categoría = más arriba en los resultados.',
        'Complete all profile fields to maximize your visibility.': 'Completá todos los campos de tu perfil para maximizar tu visibilidad.',
        ...
        'After approval, choose your category and specialties in your model dashboard. After your first validated payment, you move to that category rate.': 'Tras la aprobación, elija categoría y especialidades en su panel de profesional. Tras el primer pago validado, pasará a esa tarifa.',
        'After approval, choose your category and specialties in your professional dashboard. After your first validated payment, you move to that category rate.': 'Tras la aprobación, elija categoría y especialidades en su panel de profesional. Tras el primer pago validado, pasará a esa tarifa.',
        'Model Entrance': 'Entrada de profesional',
        'Professional Entrance': 'Entrada de profesional',
        'Explore our veiled collection of high-end models.': 'Explore nuestra colección velada de profesionals de alto nivel.',
        'Explore our veiled collection of high-end professionals.': 'Explore nuestra colección velada de profesionals de alto nivel.',
        'View Models': 'Ver profesionals',
        'View Professionals': 'Ver profesionals',
        'Model Dashboard': 'Panel de profesional',
        'Professional Dashboard': 'Panel de profesional',
        'KuraTe - Model Dashboard': 'KuraTe - Panel de profesional',
        'KuraTe - Professional Dashboard': 'KuraTe - Panel de profesional',
        ...
        'KuraTe - Admin Dashboard': 'KuraTe - Panel de administración',
        'KuraTe - Model Dashboard': 'KuraTe - Panel de profesional',
        'KuraTe - Verification': 'KuraTe - Verificación',
        ...
        'Tabla de Categorías y Precios': 'Tabla de Categorías y Precios',
        'Categoría': 'Categoría',
        'Nivel': 'Nivel',
        ...
        'KuraTe - Admin Potential Professionals': 'KuraTe - Profesionales potenciales (Admin)',
        ...
        'NOTES': 'NOTAS',
        'VIEW ALL →': 'VER MÁS →',
        'SSL certificate warning': 'Aviso de certificado SSL',
        'One or more TLS certificates expire within 10 days or are missing on the server. Certbot is not used on the VPS — renew at source and upload.': 'Uno o más certificados TLS vencen en 10 días o no están en el servidor. En el VPS no se usa Certbot — renovar en origen y subir.',
        'What to do': 'Qué hacer',
        'Run scripts/upload-ssl-certs-to-prod.bat then reload nginx (full deploy or docker compose exec nginx nginx -s reload).': 'Ejecutar scripts/upload-ssl-certs-to-prod.bat y recargar nginx (deploy completo o docker compose exec nginx nginx -s reload).',
        'SSL cert {domain}: file missing on server': 'Certificado {domain}: archivo ausente en el servidor',
        'SSL cert {domain}: read failed ({error})': 'Certificado {domain}: no se pudo leer ({error})',
        'SSL cert {domain}: expires in {days} day(s)': 'Certificado {domain}: vence en {days} día(s)',
        'SSL cert {domain}: expiration unknown': 'Certificado {domain}: vencimiento desconocido',
        ...
        'KuraTe — HIV prevention and awareness': 'KuraTe — Prevención y concientización VIH',
        'KuraTe — Breast cancer awareness and screening': 'KuraTe — Concientización y controles de cáncer de mama',
        ...
        'World AIDS Day — 1 December. KuraTe supports informed, respectful care for everyone who visits or works on the platform: guests, models and our team alike.': 'Día Mundial del SIDA — 1 de diciembre. KuraTe acompaña el cuidado informado y respetuoso de quienes navegan o trabajan en la plataforma: invitados, profesionals y nuestro equipo.',
        'National Breast Cancer Day in Argentina — 19 October. KuraTe joins the call for prevention and early detection, with respect for every woman and person with breast tissue on our platform and in our community.': 'Día Nacional del Cáncer de Mama en Argentina — 19 de octubre. KuraTe suma su voz a la prevención y la detección temprana, con respeto por cada mujer y persona con tejido mamario en la plataforma y en la comunidad.',
        'Prevention without judgment': 'Prevención sin juicios',
        'Consensual adult connections and health protection go together. Whether you browse as a guest or publish as a model, you deserve clear information and zero stigma.': 'Las conexiones adultas consensuadas y la protección de la salud van juntas. Tanto si navegás como invitado como si publicás como profesional, merecés información clara y cero estigma.',
        ...
        'For models and guests on KuraTe': 'Para profesionals e invitados en KuraTe',
        ...
        'Models: you control your boundaries and the services you offer; protecting your health is part of professional self-care.': 'profesionals: vos definís tus límites y servicios; cuidar tu salud es parte del autocuidado profesional.',
        'Guests: respect the limits each profile states; consent and discretion include respect for health choices.': 'Invitados: respetá los límites de cada perfil; consentimiento y profesionalidad incluyen respeto por las decisiones de salud.',
        ...
        'For models and guests': 'Para profesionals e invitados',
        'Health is private. KuraTe does not collect medical data and does not judge anyone’s body or choices. We share this information because caring for yourself helps you stay confident and present — in work and in life.': 'La salud es privada. KuraTe no recopila datos médicos ni juzga cuerpos ni decisiones. Compartimos esta información porque cuidarte te ayuda a sentirte segura y presente — en el trabajo y en la vida.',
        'Models: scheduling check-ups is part of sustainable self-care; your wellbeing supports the quality you offer clients.': 'profesionals: agendar controles es autocuidado sostenible; tu bienestar sostiene la calidad que ofrecés.',
        ...
        'Back to Main Dashboard': 'Volver al Panel Principal',
        'Welcome to KuraTe!': '¡Bienvenido a KuraTe!',
        ...
        'Complete your profile to be visible': 'Completá tu perfil para ser visible',
        'Your profile is not public yet. Fill in the missing fields below so clients can find you.': 'Tu perfil no es público todavía. Completá los campos faltantes para que los clientes te encuentren.',
        'field(s) remaining': 'campo(s) restante(s)',
        'Nombre': 'Nombre',
        'Apellido': 'Apellido',
        'Alias': 'Alias',
        'Documento (DNI)': 'Documento (DNI)',
        'Fecha de nacimiento': 'Fecha de nacimiento',
        'Altura': 'Altura',
        'Teléfono móvil': 'Teléfono móvil',
        'Categoría': 'Categoría',
        'Especialidades': 'Especialidades',
        'Descripción de servicios (bio)': 'Descripción de servicios (bio)',
        'Provincia': 'Provincia',
        'Ciudad': 'Ciudad',
        'Calle': 'Calle',
        'Número': 'Número',
        'Al menos 1 foto': 'Al menos 1 foto',
        ...
        'Small Appliances': 'Electro Pequeño',
        ...
        'TVs': 'Televisores',
        'Sound Systems': 'Equipos de sonido',
        'Air Conditioning': 'Aires Acondicionados',
        'Heaters': 'Calefactores',
        'Draft Heaters': 'Estufas de tiro',
        'Radiant Systems': 'Sistemas radiantes',
        'Printers': 'Impresoras',
        'Desktops': 'PC / Computadoras',
        'Laptops': 'Notebooks',
        'Monitors': 'Monitores',
        'Networking': 'Red / Networking',
        'Routers': 'Routers',
        'Switches': 'Switches',
        ...
        'Power Tools': 'Electroherramientas',
        'Commercial Refrigeration': 'Refrigeración comercial',
        'Cold Rooms': 'Cámaras',
        'Display Cases': 'Expositores',
        'Electrical': 'Electricidad',
        'Panels': 'Tableros',
        'Wiring': 'Cableado',
        'Lighting': 'Iluminación',
        'IT / Networking': 'Red / Informática',
        'Servers': 'Servidores',
        'Installations': 'Instalaciones',
        'Pneumatics': 'Neumática',
        'Hydraulics': 'Hidráulica',
        'Automation / PLC': 'Automatización / PLC',
        'Motors': 'Motores',
        'Reducers': 'Reductores',
        'Drives / Inversores': 'Variadores / Inversores',
        'Communications': 'Red / Comunicaciones',
    ...
    'zh': {
        ...
        'All Provinces': '所有省份',
        'All Cities': '所有城市',
        'All Neighborhoods': '所有地区',
        'All Specialties': '所有专业',
        'All Qualities': '所有等级',
        'Select Province': '选择省份',
        'Select City': '选择城市',
        'Select Neighborhood': '选择地区',
        'Specialties': '专业技能',
        'Category': '类别',
        'Description': '描述',
        'Photos': '照片',
        ...
        'The specialties you offer. Choose them well to appear in the right searches.': '您提供的专业服务。选择合适的专业以便在搜索中被找到。',
        'Describe your services for visitors on your public profile.': '在您的公开资料中描述您的服务。',
        'Availability': '可用时间',
        'Disponibilidad': '可用时间',
        'Horario inicio': '开始时间',
        'Horario fin': '结束时间',
        'Vacaciones desde': '休假开始',
        'Vacaciones hasta': '休假结束',
        'Fotos': '照片',
        'Subir': '上传',
        'Nombre': '姓名',
        'Apellido': '姓氏',
        ...
        'Categoría': '类别',
        'Especialidades': '专业技能',
        'Descripción de servicios (bio)': '服务描述',
        'Provincia': '省份',
        'Ciudad': '城市',
        'Calle': '街道',
        'Número': '门牌号',
        'Al menos 1 foto': '至少1张照片',
        'Información Personal': '个人信息',
        'Contacto': '联系方式',
        'Dirección': '地址',
        'Pending Admin Approval': '等待管理员审批',
        'Your profile is under review (typically up to 48 hours). Profile changes can only be made after admin approval. You will receive an email when your account is approved — please check your Spam folder too.': '您的资料正在审核中（通常48小时内）。审批通过后才能修改资料。审批通过后会收到邮件通知，请同时检查垃圾邮件。',
        'Complete your profile to be visible': '完善您的资料以公开显示',
        'Your profile is not public yet. Fill in the missing fields below so clients can find you.': '您的资料尚未公开。请填写以下缺失字段，以便客户找到您。',
        'field(s) remaining': '个字段待填写',
        'Complete your profile setup': '完成您的资料设置',
        'Leave the platform': '退出平台',
        'Delete my profile': '删除我的资料',
        'Save Changes': '保存更改',
        'Back to Main Dashboard': '返回主面板',
        'Welcome Guide': '欢迎指南',
        'Welcome to KuraTe!': '欢迎来到KuraTe！',
        'Dismiss': '关闭',
        // Service tree
        'Home': '家庭',
        'Office': '办公室',
        ...
        'Línea Marrón': '棕色家电',
        'Climatización': '温控设备',
        'Calentamiento de Agua': '热水器',
        'Baño, Sanitarios y Cuidado Personal': '浴室、卫浴和个护',
        'Línea Gris (Informática y Conectividad)': '灰色线路（IT和网络）',
        'Heladera': '冰箱',
        'Freezer': '冰柜',
        'Lavarropas': '洗衣机',
        'Microondas': '微波炉',
        'Cocina y Horno': '炉灶和烤箱',
        'Smart TV': '智能电视',
        'Sistemas de Audio y Parlantes': '音响系统',
        'Secarropa': '烘干机',
        'Aire Acondicionado': '空调',
        'Calefactores y Estufas': '加热器和炉具',
        'Termotanque y Calefón': '热水器和壁挂炉',
        'Inodoros y Bidets': '马桶和坐浴盆',
        'Duchas y Sistemas Termostáticos': '淋浴和恒温系统',
        'Lavamanos y Bachas': '洗手盆和水槽',
        'Extractores de Aire de Baño': '浴室排气扇',
        'Secadores de Pelo y Estilizadores': '吹风机和造型器',
        'Balanzas Digitales (Smart / Bioimpedancia)': '智能体重秤',
        'Hidromasajes y Jacuzzis': '按摩浴缸',
        'PCs de Escritorio y Notebooks': '台式机和笔记本',
        'Consolas de Videojuegos y Streaming': '游戏机和流媒体',
        'Impresoras Domésticas y Multifunción': '家用打印机',
        'Servidores Domésticos y Almacenamiento NAS': '家用服务器和NAS',
        'Dispositivos de Red y Routers Wi-Fi': '网络设备和路由器',
        'Frigobar y Exhibidoras': '迷你冰箱和展示柜',
        'Cafeteras Profesionales y de Cápsula': '专业咖啡机',
        'Monitores y Pantallas de Proyección': '显示器和投影',
        'Sistemas de Videoconferencia y Audio': '视频会议和音频',
        'Aire Acondicionado (Cassette y Baja Silueta)': '空调（天花式和超薄型）',
        'Calefacción Corporativa y Paneles': '企业供暖和面板',
        'Dispensers de Agua y Termotanques': '饮水机和热水器',
        'Secadores de Manos por Aire (Soplado de Alta Velocidad)': '高速干手器',
        'Dispensers Automáticos (Jabón y Sanitizante con Sensor)': '自动感应皂液器',
        'Inodoros, Mingitorios y Flujómetros con Sensor': '感应马桶和小便斗',
        'Griferías Electrónicas con Sensor de Presencia': '感应水龙头',
        'Extractores de Aire Industriales y Forzadores': '工业排气扇',
        'PCs Corporativas y Thin Clients': '企业PC和瘦客户机',
        'Impresoras Corporativas y Fotocopiadoras': '企业打印机和复印机',
        'Servidores Empresariales y Racks': '企业服务器和机架',
        'Dispositivos de Red y Switches Administrables': '网络设备和管理型交换机',
        'Freezer Horizontal y Heladeras Duales/12V': '卧式冰柜和双温冰箱',
        'Cocinas Multi-gas y Semi-Industriales': '多燃气灶和半工业灶',
        'Smart TV y Receptores Satelitales': '智能电视和卫星接收器',
        'Radios Multibanda y Audio a Batería': '多波段收音机和电池音响',
        'Estufas a Leña y Salamandras Eficientes': '高效柴火炉和壁炉',
        'Aires Inverter y Ventiladores de Techo': '变频空调和吊扇',
        'Termotanques Solares y Multi-gas': '太阳能和多燃气热水器',
        'Inodoros y Bidets (Bajo Consumo Hídrico / Aptos Pozo)': '节水马桶和坐浴盆',
        'Duchas y Sistemas Termostáticos (Aptos Baja Presión)': '低压淋浴系统',
        'Bombas Presurizadoras y Elevadoras de Agua': '增压泵和提水泵',
        'Extractores de Aire de Baño (Bajo Consumo / 12V)': '低功耗浴室排气扇',
        'Balanzas Digitales y Secadores (Eficiencia Energética A+)': '节能秤和干手器',
        'Notebooks Robustas y Equipos Bajo Consumo': '坚固型笔记本和低功耗设备',
        'Impresoras de Sistema Continuo': '连续供墨打印机',
        'Micro-Servers y Almacenamiento Local': '微型服务器和本地存储',
        'Antenas Satelitales y Routers 4G Rurales': '卫星天线和4G路由器',
        'Refrigeración Comercial y Cámaras Frigoríficas': '商用制冷和冷库',
        'Cocinas Industriales y Hornos Convectores': '工业灶和对流烤箱',
        'Pantallas de Cartelería y Monitores Industriales': '工业显示屏',
        'Sistemas de Audio Evacuación y Megafonía IP': '疏散广播和IP扩音',
        'Sistemas VRF, Chillers y Roof-Tops': 'VRF、冷水机和屋顶空调',
        'Cortinas de Aire y Ventilación Axial': '风幕机和轴流风扇',
        'Calderas Humotubulares y Termotanques Alta Potencia': '火管锅炉和大功率热水器',
        'Lavamanos de Accionamiento Mecánico (Pedal / Rodilla) y Bachas de Inox': '脚踏式洗手盆',
        'Duchas de Emergencia y Estaciones Lavaojos de Seguridad': '紧急淋浴和洗眼站',
        'Secadores de Manos Antivandalicos (Uso Intensivo)': '防暴力干手器',
        'Inodoros, Mingitorios y Flujómetros Pesados (Aptos Alto Tránsito)': '重型马桶和小便斗',
        'Estaciones de Sanitización y Dispensers Industriales IP': '消毒站和IP分配器',
        'Computadoras Industriales (IPC) y Paneles Táctiles IP65': '工业电脑和IP65触摸屏',
        'Impresoras Industriales de Código de Barras': '工业条码打印机',
        'Servidores de Planta Rugerizados y Racks IP': '加固型服务器和IP机架',
        'Switches Industriales DIN-Rail y Firewalls OT': 'DIN导轨工业交换机'
    }
};
...
export function t(text) {
    ...
    if (currentLang === 'zh') return translations['zh'][text] || text;
