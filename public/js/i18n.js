...
const translations = {
    'es': {
        ...
        'FullMinent does not create, produce, or modify any of the content found in the ads, yet all ads posted must adhere to our standards regarding age and content.': 'FullMinent no crea, produce ni modifica ninguno de los contenidos que aparecen en los anuncios; no obstante, todos los anuncios publicados deben cumplir con nuestros estándares en materia de edad y contenido.',
        'FullMinent enforces a strict policy against human trafficking, prostitution, and any illegal activities. We work in collaboration with law enforcement, following legal procedures such as subpoenas, to investigate any criminal actions. Breaching our strict policy may lead to reporting to law enforcement. I pledge not to use this site in a manner that contravenes FullMinent\u2019s policies, or any national, state, or local laws, and I commit to reporting any infringements to the authorities.': 'FullMinent aplica una política estricta contra la trata de personas, la prostitución y cualquier actividad ilegal. Colaboramos con las fuerzas de seguridad y seguimos los procedimientos legales correspondientes, como las órdenes judiciales, para investigar cualquier acción delictiva. El incumplimiento de nuestra política estricta puede dar lugar a una denuncia ante las fuerzas de seguridad. Me comprometo a no utilizar este sitio de manera que contravenga las políticas de FullMinent ni ninguna ley nacional, provincial o local, y me comprometo a denunciar cualquier infracción ante las autoridades.',
        ...
        'Professional Registration': 'Registro profesional',
        'Why FullMinent': 'Por qué FullMinent',
        ...
        'Choose how you want to join FullMinent.': 'Elegí cómo querés unirte a FullMinent.',
        ...
        'Professional Registration': 'Registro profesional',
        'Professional registration': 'Registro profesional',
        'Join FullMinent as a Professional. Complete every required field and upload your verification photos. Admin review typically takes up to 48 hours.': 'Únase a FullMinent como Profesional. Complete todos los campos obligatorios y cargue sus fotos de verificación. La revisión del administrador suele demorar hasta 48 horas.',
        ...
        'Enter Sanctuary': 'Entrar al plataforma',
        ...
        'Welcome to FullMinent!': '¡Bienvenida a FullMinent!',
        ...
        'If you no longer wish to remain on FullMinent, you can permanently delete your profile and all associated data.': 'Si ya no desea permanecer en FullMinent, puede eliminar permanentemente su perfil y todos los datos asociados.',
        ...
        'FullMinent - Model Dashboard': 'FullMinent - Panel de profesional',
        'FullMinent - Professional Dashboard': 'FullMinent - Panel de profesional',
        ...
        'Sanctuary': 'plataforma',
        'FullMinent - Admin Dashboard': 'FullMinent - Panel de administración',
        'FullMinent - Model Dashboard': 'FullMinent - Panel de profesional',
        'FullMinent - Verification': 'FullMinent - Verificación',
        ...
        'FullMinent - Admin Potential Professionals': 'FullMinent - Profesionales potenciales (Admin)',
        ...
        'FullMinent — HIV prevention and awareness': 'FullMinent — Prevención y concientización VIH',
        'FullMinent — Breast cancer awareness and screening': 'FullMinent — Concientización y controles de cáncer de mama',
        ...
        'World AIDS Day — 1 December. FullMinent supports informed, respectful care for everyone who visits or works on the platform: guests, models and our team alike.': 'Día Mundial del SIDA — 1 de diciembre. FullMinent acompaña el cuidado informado y respetuoso de quienes navegan o trabajan en la plataforma: invitados, profesionals y nuestro equipo.',
        'National Breast Cancer Day in Argentina — 19 October. FullMinent joins the call for prevention and early detection, with respect for every woman and person with breast tissue on our platform and in our community.': 'Día Nacional del Cáncer de Mama en Argentina — 19 de octubre. FullMinent suma su voz a la prevención y la detección temprana, con respeto por cada mujer y persona con tejido mamario en la plataforma y en la comunidad.',
        ...
        'For models and guests on FullMinent': 'Para profesionals e invitados en FullMinent',
        ...
        'Health is private. FullMinent does not collect medical data and does not judge anyone’s body or choices. We share this information because caring for yourself helps you stay confident and present — in work and in life.': 'La salud es privada. FullMinent no recopila datos médicos ni juzga cuerpos ni decisiones. Compartimos esta información porque cuidarte te ayuda a sentirte segura y presente — en el trabajo y en la vida.',
        ...
        'Back to Main Dashboard': 'Volver al Panel Principal',
        'Welcome to FullMinent!': '¡Bienvenido a FullMinent!',
