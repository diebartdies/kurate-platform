...
export const CATEGORY_META = {
    'verificados': { name: '⭐ Verificados', alias: 'Experto', logo: '<svg viewBox="0 0 40 50" width="100%"><rect x="2" y="2" width="36" height="46" fill="none" stroke="currentColor" stroke-width="2" rx="4"/><text x="20" y="22" font-family="serif" font-size="14" fill="currentColor" text-anchor="middle" font-weight="bold">V</text><text x="20" y="36" font-family="serif" font-size="14" fill="currentColor" text-anchor="middle" font-weight="bold">✓</text></svg>', desc: 'Profesionales verificados y certificados', price: '$50.000.- ARS', monthlyPrice: 50000, priceUnit: 'ARS' },
    'Premium': { name: '✨ Premium', alias: 'Maestro', logo: '<svg viewBox="0 0 100 40" width="100%"><path d="M10,20 Q30,0 50,20 Q30,40 10,20 Z M90,20 Q70,0 50,20 Q70,40 90,20 Z" fill="none" stroke="currentColor" stroke-width="2"/><circle cx="50" cy="20" r="10" fill="none" stroke="currentColor" stroke-width="2"/><text x="50" y="25" font-family="serif" font-size="14" fill="currentColor" text-anchor="middle" font-weight="bold">M</text></svg>', desc: 'Alta performance y excelencia', price: '$40.000.- ARS', monthlyPrice: 40000, priceUnit: 'ARS' },
    'Gold': { name: '🟡 Gold', alias: 'Profesional', logo: '<svg viewBox="0 0 64 64" fill="none" stroke="currentColor" stroke-width="3" width="100%"><circle cx="32" cy="32" r="28"/><path d="M32 4 L32 32 L10 46 M32 32 L54 46"/></svg>', desc: 'Experiencia y confianza comprobada', price: '$30.000.- ARS', monthlyPrice: 30000, priceUnit: 'ARS' },
    'Silver': { name: '⚪ Silver', alias: 'Técnico', logo: '<svg viewBox="0 0 100 40" width="100%"><circle cx="26" cy="20" r="12"/><circle cx="42" cy="20" r="12"/><circle cx="58" cy="20" r="12"/><circle cx="74" cy="20" r="12"/></svg>', desc: 'Estilo moderno y eficiente', price: '$20.000.- ARS', monthlyPrice: 20000, priceUnit: 'ARS' },
    'Standard': { name: '🟤 Standard', alias: 'Inicial', logo: '<svg viewBox="0 0 64 64" fill="none" stroke="currentColor" stroke-width="4" width="100%"><ellipse cx="32" cy="32" rx="28" ry="18" /><ellipse cx="32" cy="32" rx="18" ry="7" /><ellipse cx="32" cy="20" rx="6" ry="12" /></svg>', desc: 'Confiabilidad funcional del día a día', price: '$15.000.- ARS', monthlyPrice: 15000, priceUnit: 'ARS' },
